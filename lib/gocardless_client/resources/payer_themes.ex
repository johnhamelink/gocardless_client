defmodule GoCardlessClient.Resources.PayerThemes do
  @moduledoc """
  GoCardlessClient Payer Themes API.

  See https://developer.gocardless.com/api-reference/#payer-themes for full documentation.
  """
  ...
  @doc "Creates a new payer themes resource."
  ...
  @doc "Retrieves a single payer themes by ID."
  ...
  @doc "Lists payer_themes with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of payer_themes."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all payer_themes into a list across all pages."
