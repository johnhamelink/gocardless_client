defmodule GoCardlessClient.Resources.TransferredMandates do
  @moduledoc """
  GoCardlessClient Transferred Mandates API.

  See https://developer.gocardless.com/api-reference/#transferred-mandates for full documentation.
  """
  ...
  @doc "Creates a new transferred mandates resource."
  ...
  @doc "Retrieves a single transferred mandates by ID."
  ...
  @doc "Updates a transferred mandates."
  ...
  @doc "Lists transferred_mandates with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of transferred_mandates."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all transferred_mandates into a list across all pages."
