defmodule GoCardlessClient.Resources.Transfers do
  @moduledoc """
  GoCardlessClient Transfers API.

  See https://developer.gocardless.com/api-reference/#transfers for full documentation.
  """

  alias GoCardlessClient.{Client, Paginator, Resource}

  @resource_key "transfers"
  @base_path "/transfers"

  @doc "Creates a new transfers resource."
  ...
  @doc "Retrieves a single transfers by ID."
  ...
  @doc "Lists transfers with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of transfers."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all transfers into a list across all pages."
