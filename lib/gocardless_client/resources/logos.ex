defmodule GoCardlessClient.Resources.Logos do
  @moduledoc """
  GoCardlessClient Logos API.

  See https://developer.gocardless.com/api-reference/#logos for full documentation.
  """
  ...
  @doc "Creates a new logos resource."
  ...
  @doc "Retrieves a single logos by ID."
  ...
  @doc "Lists logos with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of logos."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all logos into a list across all pages."
