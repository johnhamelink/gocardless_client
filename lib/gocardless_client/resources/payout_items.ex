defmodule GoCardlessClient.Resources.PayoutItems do
  @moduledoc """
  GoCardlessClient Payout Items API.

  See https://developer.gocardless.com/api-reference/#payout-items for full documentation.
  """
  ...
  @doc "Creates a new payout items resource."
  ...
  @doc "Retrieves a single payout items by ID."
  ...
  @doc "Lists payout_items with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of payout_items."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all payout_items into a list across all pages."
