defmodule GoCardlessClient.Resources.TaxRates do
  @moduledoc """
  GoCardlessClient Tax Rates API.

  See https://developer.gocardless.com/api-reference/#tax-rates for full documentation.
  """
  ...
  @doc "Creates a new tax rates resource."
  ...
  @doc "Retrieves a single tax rates by ID."
  ...
  @doc "Lists tax_rates with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of tax_rates."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all tax_rates into a list across all pages."
