defmodule GoCardlessClient.Resources.BankAccountHolderVerifications do
  @moduledoc """
  GoCardlessClient Bank Account Holder Verifications API.

  See https://developer.gocardless.com/api-reference/#bank-account-holder-verifications for full documentation.
  """
  ...
  @doc "Creates a new bank account holder verifications resource."
  ...
  @doc "Retrieves a single bank account holder verifications by ID."
  ...
  @doc "Updates a bank account holder verifications."
  ...
  @doc "Lists bank_account_holder_verifications with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of bank_account_holder_verifications."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all bank_account_holder_verifications into a list across all pages."
