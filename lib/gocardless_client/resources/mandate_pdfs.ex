defmodule GoCardlessClient.Resources.MandatePDFs do
  @moduledoc """
  GoCardlessClient Mandate Pdfs API.

  See https://developer.gocardless.com/api-reference/#mandate-pdfs for full documentation.
  """
  ...
  @doc "Creates a new mandate pdfs resource."
  ...
  @doc "Retrieves a single mandate pdfs by ID."
  ...
  @doc "Lists mandate_pdfs with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of mandate_pdfs."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all mandate_pdfs into a list across all pages."
