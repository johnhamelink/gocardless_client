defmodule GoCardlessClient.Resources.Refunds do
  @moduledoc """
  ...
  @doc "Creates a refund against a payment. Pass an idempotency key for safe retries."
  ...
  @doc "Retrieves a single refund by ID."
  ...
  @doc "Returns a page of refunds with optional filters."
  ...
  @doc "Returns a lazy `Stream` over all pages of refunds."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all refunds into a list."
