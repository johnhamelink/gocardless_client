defmodule GoCardlessClient.Resources.Institutions do
  @moduledoc """
  GoCardlessClient Institutions API.

  See https://developer.gocardless.com/api-reference/#institutions for full documentation.
  """
  ...
  @doc "Creates a new institutions resource."
  ...
  @doc "Retrieves a single institutions by ID."
  ...
  @doc "Lists institutions with optional filter params."
  ...
  @doc "Eagerly collects all institutions into a list across all pages."
