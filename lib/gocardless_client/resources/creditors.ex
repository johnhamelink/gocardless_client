defmodule GoCardlessClient.Resources.Creditors do
  @moduledoc """
  GoCardlessClient Creditors API.

  See https://developer.gocardless.com/api-reference/#creditors for full documentation.
  """

  alias GoCardlessClient.{Client, Paginator, Resource}

  @resource_key "creditors"
  @base_path "/creditors"

  @doc "Creates a new creditors resource."
  ...
  @doc "Retrieves a single creditors by ID."
  ...
  @doc "Lists creditors with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of creditors."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all creditors into a list across all pages."
