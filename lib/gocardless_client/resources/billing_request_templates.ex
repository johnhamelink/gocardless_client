defmodule GoCardlessClient.Resources.BillingRequestTemplates do
  @moduledoc """
  GoCardlessClient Billing Request Templates API.

  See https://developer.gocardless.com/api-reference/#billing-request-templates for full documentation.
  """
  ...
  @doc "Creates a new billing request templates resource."
  ...
  @doc "Retrieves a single billing request templates by ID."
  ...
  @doc "Updates a billing request templates."
  ...
  @doc "Lists billing_request_templates with optional filter params."
  ...
  @doc "Returns a lazy `Stream` over all pages of billing_request_templates."
  @spec stream(Client.t(), map(), keyword()) :: Enumerable.t()
  def stream(%Client{} = client, params \\ %{}, opts \\ []) do
    Paginator.stream(client, @base_path, params, @resource_key, opts)
  end

  @doc "Eagerly collects all billing_request_templates into a list across all pages."
